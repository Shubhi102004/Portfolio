import { assets, infoList, toolsDataNew } from '@/assets/assets'
      ...
      className='text-center text-3xl sm:text-4xl md:text-5xl mb-8 sm:mb-12 font-Ovo'>
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-6 sm:gap-8 lg:gap-12'>
            ...
            className='flex-1 min-w-0 px-2 sm:px-4 lg:px-0'>
                ...
                className='mb-2 sm:mb-3 text-gray-700 font-Ovo dark:text-white/80 text-sm sm:text-base'>Tools I use</motion.h4>
                    ...
                    {toolsDataNew.map((tool, index)=>(
                        ...
                        className='flex items-center justify-center w-10 sm:w-12 md:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:-translate-y-1 duration-500'
                         ...
                         title={tool.name}>
                            ...
                            />
                            <div 
                                className='w-4 sm:w-5 md:w-7 text-center text-xs font-bold text-gray-600 dark:text-gray-300'
                                style={{display: 'none'}}
                            >
                                {tool.name.charAt(0)}
                            </div>
