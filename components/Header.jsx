    ...
    <div ref={headerRef} className='w-11/12 max-w-3xl text-center mx-auto flex flex-col items-center justify-center gap-3 pt-28 pb-16'>
      ...
      <motion.h3 
        ...
        className='flex items-end gap-2 text-xl md:text-2xl mb-2 font-Ovo'>
            Hi! I'am Shubhi Shrivastava <motion.div
      ...
      <motion.h1 
        ...
        Full Stack Developer Based in India.</motion.h1>
      ...
      <motion.p
        ...
        I am a Full Stack Developer From Bhopal, India specializing in Frontend and Backend Technologies, 
        creating end-to-end web solutions and contributing to Open Source projects.
      </motion.p>
      ...
      <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
        <motion.a 
          ...
          whileTap={{ scale: 0.95 }}
          href="#contact"
          className='px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent hover:bg-gray-800 dark:hover:bg-gray-800 transition-colors duration-300 astro-hover-button'
        >
      ...
      >
        <a href="https://github.com/Shubhi102004" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
        ...
        <a href="https://www.linkedin.com/in/shubhi-shrivastava/" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
          </svg>
        </a>
        <a href="https://www.instagram.com/_shubhi_shrivastava_" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="https://x.com/" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
