...
const Header = ({isDarkMode}) => {
  ...
  return (
    <div ref={headerRef} className='w-11/12 max-w-3xl text-center mx-auto flex flex-col items-center justify-center gap-3 pt-28 pb-16'>
      ...
      >
        <a href="https://github.com/DrDead0" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
        ...
        <a href="https://www.instagram.com/a.shiss.h" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <a href="https://x.com/I_Am_Mr_Ashu" target="_blank" rel="noopener noreferrer" className='hover:scale-110 transition-transform duration-300 astro-hover'>
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
